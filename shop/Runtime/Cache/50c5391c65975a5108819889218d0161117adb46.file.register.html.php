<?php /* Smarty version Smarty-3.1.6, created on 2017-07-27 13:26:19
         compiled from "D:/phpStudy/WWW/tp3/shop/Home/View\User\register.html" */ ?>
<?php /*%%SmartyHeaderCode:4331596d5cce9dbb19-82484457%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '50c5391c65975a5108819889218d0161117adb46' => 
    array (
      0 => 'D:/phpStudy/WWW/tp3/shop/Home/View\\User\\register.html',
      1 => 1501133171,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '4331596d5cce9dbb19-82484457',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.6',
  'unifunc' => 'content_596d5ccef2354',
  'variables' => 
  array (
    'errorInfo' => 0,
  ),
...
<?php if ($_valid && !is_callable('content_596d5ccef2354')) {function content_596d5ccef2354($_smarty_tpl) {?><!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Strict//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-strict.dtd">
...
<script type="text/javascript">
    function checkname(){
        ...
        xhr.onreadystatechange = function(){
            if (xhr.readyState==4) {
                document.getElementById('username_check').innerHTML = xhr.responseText;
            }
        }
        //thinkPHP框架所有操作都是“控制器-操作方法的结合
        var ming = document.getElementById('User_username').value;
         ...
         <input class="inputBg" size="25" name="username" id="User_username" type="text" value="" onblur="checkname()"/>
           <span id="username_check"></span>
            ...
            <tr>
                ...
                <td>
                    <input class="inputBg" size="25" name="password" id="User_password" type="password" value="" />        <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['password'];?>
</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input class="inputBg" size="25" name="user_email" id="User_user_email" type="text" value="" />    <span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['user_email'];?>
</span>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td>
                    <input class="inputBg" size="25" name="user_tel" id="User_user_tel" type="text" value="" /><span style="color:red;"><?php echo $_smarty_tpl->tpl_vars['errorInfo']->value['user_tel'];?>
</span>
                </td>
            </tr>
            <tr>
...
ecmoban.gif" alt="YONGDA商城" border="0"></a>

                    <a href="#" target="_blank" title="YONGDA 网上商店管理系统">
                        <img src="<?php echo @IMG_URL;?>
yahoo.gif" alt="YONGDA 网上商店管理系统" border="0" />
                    </a>
